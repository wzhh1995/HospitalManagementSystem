...
<body>
	...
	<div class="" style="background-color: cornflowerblue">
		...
		<div class="container"
			style="background-image: url('img/logman.jpg'); height: 450px">
			<div class="row">
				<article class="span8 form-box"
					style="margin-left: 300px; margin-top: 60px">
					<div>
						<br>
						<h5 style="color: cornflowerblue; margin-left: 20px">Manager
							Login</h5>
						<form name="ma" action="alogin" method="post"
							...
							<input type="submit" value="" class="btn btn-primary btn2"
								style="margin-left: 10px; width: 95px; height: 35px; background-image: url('img/sub.png')" />
							<input type="reset" value="" class="btn btn-primary btn2"
								style="margin-left: px; width: 85px; height: 35px; background-image: url('img/res.png')" />
						</form>
					</div>
				</article>
			</div>
