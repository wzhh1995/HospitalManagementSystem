		...
		<div class="container padBot"
			...
			<div class="row" style="margin-left: 20px">
				...
				<article class="span8 about-box"
					...
					<h5 style="margin-left: 150px">Patients Status</h5>
					<table style="margin-left: -160px; width: 1000px">
						...
						<%
							String id, summary, dec, dev, dep, name, imp, action = null;
							String sql = "select * from patients where doctor='" + user + "' and status!='Cured'";
